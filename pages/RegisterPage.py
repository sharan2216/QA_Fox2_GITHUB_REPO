...
class RegisterPage:
    ...
    password_confirm_field_id = "input-password"
    ...
    last_name_warning_message="//input[@id='input-lastname']/following-sibling::div"
    ...
    def enter_last_name(self,first_name_text):
        self.driver.find_element(By.ID,self.last_name_field_id).click()
        self.driver.find_element(By.ID, self.last_name_field_id).clear()
        self.driver.find_element(By.ID, self.last_name_field_id).send_keys(first_name_text)
    ...
    def enter_password_confirm(self,password_text):
        ...
        self.driver.find_element(By.ID, self.password_confirm_field_id ).send_keys(password_text)
    ...
    def retrieve_last_name_warning(self):
        return self.driver.find_element(By.XPATH,self.last_name_warning_message).text
